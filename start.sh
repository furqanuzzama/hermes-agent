...
hermes config set model.name "deepseek/deepseek-r1-0528:free"
hermes config set model.default "deepseek/deepseek-r1-0528:free"
hermes config set agent.model "deepseek/deepseek-r1-0528:free"
